...
{
	/// <summary>
	/// Default processor implementation with support of [Networked] properties, runtime lookup synchronization, based on NetworkTRSP.
	...
	/// </summary>
    public unsafe abstract class NetworkTRSPProcessor : NetworkTRSP, IKCCProcessor, IKCCProcessorProvider
    {
